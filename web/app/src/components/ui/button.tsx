...
type ButtonSize = ButtonSizeCanonical | "xs" | "sm" | "md" | "lg" | "icon-xs" | "icon-sm" | "icon-lg";
...
const bgVariants: Record<string, string> = {
	...
	destructive:
		"[--btn-bg:var(--destructive-light,#450A0A)] group-hover:[--btn-bg:color-mix(in_oklab,var(--destructive-light,#450A0A)_80%,var(--background))] group-active:[--btn-bg:var(--destructive-light,#450A0A)] bg-[var(--btn-bg)] shadow-[0_0_0_1px_var(--border)]",
...
const activeBgVariants: Record<string, string> = {
	...
	destructive: "bg-active shadow-[0_0_0_1px_var(--border)]",
	link: "bg-transparent shadow-none",
};

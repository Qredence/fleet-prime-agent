...
import { getRightPanelDefinition } from "@/components/layout/right-panel-registry";
import { MobilePanel, RightPanelTabsFromContext } from "@/components/workspace/right-panel-launcher";

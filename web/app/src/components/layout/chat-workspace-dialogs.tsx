...
const LazyChatCommandPalette = lazy(() =>
	import("@/components/layout/chat-command-palette").then(({ ChatCommandPalette }) => ({
		default: ChatCommandPalette,
	})),
);
const LazySettingsDialog = lazy(() =>
	import("@/components/settings/settings-dialog").then(({ SettingsDialog }) => ({
		default: SettingsDialog,
	})),
);
const LazyForkPickerDialog = lazy(() =>
	import("@/components/chat/fork-picker-dialog").then(({ ForkPickerDialog }) => ({

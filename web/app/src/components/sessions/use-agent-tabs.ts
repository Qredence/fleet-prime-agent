...
import { type ChatClient, chatClient } from "@/components/chat/chat-client";
import { normalizeSessionLabel } from "@/components/chat/chat-helpers";
import { orderedRlmChildren } from "@/components/chat/subagents/subagent-utils";
import { useSubagentChat } from "@/components/chat/subagents/use-subagent-chat";
import type { AgentTabItem } from "@/components/sessions/agent-tab-bar";
import {
	INITIAL_AGENT_TAB_SCOPE_STATE,
	reduceAgentTabScope,
	visibleAgentTabScope,
} from "@/components/sessions/agent-tab-state";

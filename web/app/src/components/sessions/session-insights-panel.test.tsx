...
import { deriveSessionInsights } from "@/components/sessions/session-insights";
import { SessionInsightsPanel } from "@/components/sessions/session-insights-panel";
import { EMPTY_CHAT_TRANSCRIPT_SUMMARY, summarizeChatTranscript } from "@/components/sessions/transcript-summary";
import { RightPanelLauncher, RightPanelTrigger } from "@/components/workspace/right-panel-launcher";
...
describe("SessionInsightsPanel", () => {
	...
	it("adds Session insights to the existing right-panel tabs", () => {
		...
		render(<RightPanelLauncher activePanel={null} onPanelChange={onPanelChange} resources={null} workspace={null} />);

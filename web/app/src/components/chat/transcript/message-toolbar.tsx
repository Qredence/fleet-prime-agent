	...
	return (
		<button
			...
			className={cn(
				...
				"bg-transparent opacity-50 hover:bg-foreground/10 hover:opacity-100",
			)}
		>
...
export function MessageToolbar({
	...
	return (
		<div
			className={cn(
				"pointer-events-none flex items-center gap-1 pt-1 text-xs text-muted-foreground/70 opacity-0 transition-opacity duration-100",
				heightClass,
				alignClass,
				hoverClass,

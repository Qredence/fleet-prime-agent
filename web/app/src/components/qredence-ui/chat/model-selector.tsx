...
import { ComposerSelectorTrigger } from "@/components/qredence-ui/chat/composer/input/composer-selector-trigger";
import { Popover } from "@/components/qredence-ui/chat/composer/input/input-popover";
import { cn } from "@/lib/utils";

const LazyModelSelectorList = lazy(() =>
	import("@/components/qredence-ui/chat/model-selector-list").then(({ ModelSelectorList }) => ({

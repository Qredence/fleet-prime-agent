...
import { useMessageScrollerRail } from "@/components/qredence-ui/chat/message/message-scroller-rail";
import { PreviewRail } from "@/components/qredence-ui/motion/preview-rail";
...
export function MessageScroller({
	...
	const { activeRailId, railItems, railOverflowing, scheduleRailSync, scrollToRailItem } = useMessageScrollerRail({
		navigation,
		followThreshold,
		contentRef,
		viewportRef,

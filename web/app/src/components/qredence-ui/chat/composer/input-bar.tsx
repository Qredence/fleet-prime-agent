...
import { AGENT_CHAT_MODES } from "@/components/qredence-ui/chat/chat-modes";
import { ComposerLoader } from "@/components/qredence-ui/chat/composer/composer-loader";
import {
	type ComposerTriggerItem,
	ComposerTriggerPopover,
} from "@/components/qredence-ui/chat/composer/composer-trigger-popover";
import type { InlineCompletion } from "@/components/qredence-ui/chat/composer/inline-completion";
import { FileAttachment } from "@/components/qredence-ui/chat/composer/input/file-attachment";
import { ModeSelector } from "@/components/qredence-ui/chat/composer/input/mode-selector";
import { InputQuestionBar } from "@/components/qredence-ui/chat/composer/input/question-bar";
import type { SuggestionItem } from "@/components/qredence-ui/chat/composer/input/suggestions";
import { useInputBarState } from "@/components/qredence-ui/chat/composer/input-bar-state";
import { PromptInput } from "@/components/qredence-ui/chat/composer/prompt-input";
import type { QuestionBarData } from "@/components/qredence-ui/chat/hooks/use-question-bar-navigation";
import { ModelSelector } from "@/components/qredence-ui/chat/model-selector";
import {
	CHAT_COLUMN_CLASS,
	COMPOSER_ADD_BUTTON_CLASS,
	HIT_AREA_EXPAND_CLASS,
} from "@/components/qredence-ui/chrome/tokens";

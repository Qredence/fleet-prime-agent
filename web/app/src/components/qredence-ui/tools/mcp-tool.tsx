...
import type { McpToolInfo } from "@/components/qredence-ui/tools/tool-registry";
...
export const McpTool = memo(function McpTool({ part, mcpInfo, chatStatus, defaultOpen }: McpToolProps) {
	...
	if (isInterrupted && !part.output) {
		return <span className="text-sm text-muted-foreground">{mcpInfo.displayName} interrupted</span>;
	}

...
function OpenAiMark({ className }: { className?: string }) {
	return (
		<svg viewBox="0 0 24 24" className={cn(BRAND_CLASS, className)} fill="currentColor" aria-hidden>
...
export function ProviderBrandIcon({
	...
	const Icon = provider in PROVIDER_METADATA ? PROVIDER_METADATA[provider].icon : Cpu;

...
} from "@/components/qredence-ui/panels/config-panel/sections/provider-credentials-editor";
import { ActiveProviderList } from "@/components/qredence-ui/panels/config-panel/sections/provider-credentials-list";
import {
	isOAuthProvider,
...
import { useProviderCredentialsController } from "@/components/qredence-ui/panels/config-panel/sections/use-provider-credentials-controller";
	...
	return (
		...
		>
			{addPickerOpen ? (
				...
				/>
			) : editingUnconfiguredProvider && isOAuthProvider(editingUnconfiguredProvider) ? (
				<AddProviderOAuthPanel
				...
				<div className="flex flex-col gap-3">
					...
					{isLoading ? (
						...
						<div className="flex flex-col items-center gap-3 py-8">
							<p className="text-center text-xs text-pretty text-muted-foreground">No providers configured</p>
							<Button
								type="button"
								variant="outline"
								size="sm"

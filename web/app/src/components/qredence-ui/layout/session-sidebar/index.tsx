...
} from "@/components/qredence-ui/layout/session-sidebar/action-dialogs";
import { SessionSidebarNavigation } from "@/components/qredence-ui/layout/session-sidebar/navigation";
import { useSessionSidebarState } from "@/components/qredence-ui/layout/session-sidebar/state";
import { EMPTY_PROJECTS, type SessionSidebarProps } from "@/components/qredence-ui/layout/session-sidebar/types";
import { useSessionSidebarViewModel } from "@/components/qredence-ui/layout/session-sidebar/view-model";

export type { SessionSidebarProps } from "@/components/qredence-ui/layout/session-sidebar/types";
...
const LazySessionSidebarCreateDialog = lazy(() =>
	import("@/components/qredence-ui/layout/session-sidebar/create-project-dialog").then(
		({ SessionSidebarCreateDialog }) => ({

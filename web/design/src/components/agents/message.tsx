...
import { MessageSideContext } from "@prime-agent/web-design/components/agents/message-context";
...
export {
  ...
  MessageBubbleGroup,
} from "@prime-agent/web-design/components/agents/message-bubble";
export { MessageScroller } from "@prime-agent/web-design/components/agents/message-scroller";
export type { MessageScrollerProps } from "@prime-agent/web-design/components/agents/message-scroller";

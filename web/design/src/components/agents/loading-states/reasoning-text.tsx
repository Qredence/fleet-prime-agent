...
import { Loader } from "@prime-agent/web-design/components/motion/loader";
import { TextScramble } from "@prime-agent/web-design/components/motion/text-scramble";
import { EASE_OUT, SPRING_SWAP } from "@prime-agent/web-design/lib/ease";
import {
  TEXT_SHIMMER_CLASS_NAME,
  TEXT_SHIMMER_KEYFRAMES,
  textShimmerStyle,
} from "@prime-agent/web-design/lib/text-shimmer";

...
export function InputInfoBar({ infoBar, isOpen, position, onClose }: InputInfoBarProps) {
	return (
		<div
			className={cn(
				...
				position === "top" ? "rounded-t-an-input-border-radius" : "rounded-b-an-input-border-radius",
			)}
		>

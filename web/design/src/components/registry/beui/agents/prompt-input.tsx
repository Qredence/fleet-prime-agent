...
} from "@prime-agent/web-design/components/registry/beui/motion/animated-select";
					...
					>
						<AnimatedSelectTrigger className="h-8 w-auto max-w-52 rounded-xl border-0 bg-transparent px-2 py-0 text-xs hover:bg-muted focus-visible:ring-2">
							<span className="flex min-w-0 items-center gap-1.5">
								...
								<span className="truncate text-foreground/70">{currentModel?.label ?? "Choose model"}</span>
							</span>
						</AnimatedSelectTrigger>

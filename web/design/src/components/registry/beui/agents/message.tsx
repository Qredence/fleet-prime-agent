...
export {
	...
	MessageBubbleGroup,
} from "@prime-agent/web-design/components/registry/beui/agents/message-bubble";
export type { MessageScrollerProps } from "@prime-agent/web-design/components/registry/beui/agents/message-scroller";
export { MessageScroller } from "@prime-agent/web-design/components/registry/beui/agents/message-scroller";
...
export function MessageHeader({ className, ...props }: MessageHeaderProps) {
	...
	return (
		<div
			...
			className={cn(
				"flex items-center gap-1.5 px-1 text-caption leading-none text-muted-foreground",
...
export function MessageFooter({ className, ...props }: MessageFooterProps) {
	...
	return (
		<div
			...
			className={cn(
				"flex min-h-5 items-center gap-1 px-1 text-caption text-muted-foreground",
				from === "user" ? "justify-end" : "justify-start",
				className,
			)}
			{...props}

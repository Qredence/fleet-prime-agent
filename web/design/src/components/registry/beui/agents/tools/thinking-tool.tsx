...
function ThinkingCollapsed({ step, state, onComplete, defaultOpen, expanded, onToggleExpand }: ThinkingCollapsedProps) {
	...
	return (
		...
		>
			<div className="max-h-[175px] overflow-y-auto">
				<p className="text-sm whitespace-pre-wrap text-muted-foreground">{step.thoughtContent}</p>
			</div>
		</ToolRowBase>
	);
}

				...
				<span className="text-xs text-an-tool-color-muted">
					...
					{statusConfig.dots && (
						<span className="inline-flex" aria-hidden="true">
							<span className="animate-[loading-dots_1.4s_infinite_0.2s] text-an-tool-color-muted">.</span>
							<span className="animate-[loading-dots_1.4s_infinite_0.4s] text-an-tool-color-muted">.</span>
							<span className="animate-[loading-dots_1.4s_infinite_0.6s] text-an-tool-color-muted">.</span>
						</span>
					)}
				</span>
			) : (

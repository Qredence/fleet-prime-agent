...
function detectChanges(oldTodos: Array<TodoItem>, newTodos: Array<TodoItem>): DetectedChanges {
...
const TodoListItem = memo(function TodoListItem({ todo, isPending }: { todo: TodoItem; isPending: boolean }) {
	return (

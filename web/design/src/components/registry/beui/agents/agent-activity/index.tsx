...
import { ThinkingShimmer } from "@prime-agent/web-design/components/registry/beui/agents/loading-states/thinking-shimmer";
...
export function AgentActivity({
	...
	return (
		...
		>
			{working ? (
				<div id={triggerId} role="status" className="flex h-7 min-w-0 items-center text-muted-foreground">
					{renderWorkingStatus ? (

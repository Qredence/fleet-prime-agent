		...
		<div className={cn("flex flex-col gap-2 bg-background px-3 py-2", className)}>
					...
					{customEnabled && (
						<div className="flex items-center gap-2 pt-1">
							...
							<input
								...
								className="h-7 w-full rounded-md border border-border bg-background px-2 text-base text-an-tool-color md:text-sm"
							/>
						</div>
					)}
				</div>
			...
			{activeQuestion.kind === "text" && (
				<textarea
					...
					rows={3}
					className="w-full resize-y rounded-md border border-border bg-background px-2 py-1.5 text-base text-an-tool-color md:text-sm"
				/>
			)}

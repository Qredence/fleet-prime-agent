...
import type { AgentCodeLanguage } from "@prime-agent/web-design/components/registry/beui/agents/agent-code";
...
function ToolResultAction({ label, onClick, children }: { label: string; onClick: () => void; children: ReactNode }) {
...
export function ToolResultOutput({ children, language: _language = "bash", label, className }: ToolResultOutputProps) {
	return (

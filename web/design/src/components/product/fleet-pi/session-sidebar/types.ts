...
export type FleetSessionActions = {
	onNewSession: () => void;
...
export type FleetProjectActions = {
...
export type FleetSidebarNavigationActions = {
...
export type FleetSessionSidebarSlots = {
	accountMenu?: ReactNode;
};

export type FleetSessionSidebarProps = {
	data: FleetSessionSidebarData;
	sessionActions: FleetSessionActions;
	projectActions?: FleetProjectActions;
	navigationActions?: FleetSidebarNavigationActions;
	slots?: FleetSessionSidebarSlots;
};

export type FleetSessionSidebarDependencies = FleetSessionSidebarData &
	FleetSessionActions &
	FleetProjectActions &
	FleetSidebarNavigationActions &
	FleetSessionSidebarSlots;

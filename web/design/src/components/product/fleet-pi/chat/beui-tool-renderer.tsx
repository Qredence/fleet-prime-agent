...
} from "../../../registry/assistant-ui/elements/fleet-agent-plan";
import type { AgentCodeLanguage } from "../../../registry/beui/agents/agent-code";
import { Citations } from "../../../registry/beui/agents/citations";
import { CodeBlock } from "../../../registry/beui/agents/code-block";
import { FileDiff } from "../../../registry/beui/agents/file-diff";
import { ImageGeneration } from "../../../registry/beui/agents/image-generation";
import { type TodoItem, TodoList } from "../../../registry/beui/agents/todo-list";
import { ToolApproval } from "../../../registry/beui/agents/tool-approval";
...
import { type FleetToolRecord, normalizeFleetToolPart } from "./beui-tool-normalizer";
...
function Approval({ approval, name, status }: { approval?: FleetToolRecord; name: string; status: ToolResultStatus }) {

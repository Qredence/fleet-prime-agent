...
} from "../../../registry/assistant-ui/elements/composer-trigger-popover";
import { ModelSelector } from "../../../registry/assistant-ui/elements/model-selector";
...
import { ModeSelector } from "../../../registry/beui/agents/input/mode-selector";
import { InputQuestionBar } from "../../../registry/beui/agents/input/question-bar";
...
export type FleetPiInputBarProps = Omit<InputBarProps, "leftActions" | "rightActions" | "status"> & {

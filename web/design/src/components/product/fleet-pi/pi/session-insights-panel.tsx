...
import { deriveSessionInsights, RLM_CHILD_STATUSES, type SessionInsightsInput } from "./session-insights";
			...
			{presentation.recap ? (
				<DetailList label="Existing recap">
					<Detail
						label="Summary"
						value={
							<span className="block max-w-56 whitespace-pre-wrap text-left text-pretty">
								{presentation.recap}
							</span>
						}
					/>

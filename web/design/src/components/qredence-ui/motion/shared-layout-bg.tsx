...
export const SharedLayoutBg = forwardRef<HTMLElement, SharedLayoutBgProps>(function SharedLayoutBg(
	{ children, as = "div", className, onMouseLeave, pillClassName, pillContainerClassName, inset = 20, ...props },
	forwardedRef,
) {
	...
	const renderedChildren = Children.toArray(children).reduce<ReactNode[]>((result, child, index) => {

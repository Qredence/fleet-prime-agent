...
import { usePopoverPortalPosition } from "@prime-agent/web-design/components/qredence-ui/motion/popover-position";
...
export function ComboboxContent({
	...
	useLayoutEffect(() => {
		...
		if (side === "bottom" && below < layout.content.height + sideOffset && above > below) setActualSide("top");
		else if (side === "top" && above < layout.content.height + sideOffset && below > above) setActualSide("bottom");
			...
			style={
				{
					...
					left,
					top: actualSide === "bottom" && layout ? layout.trigger.top + layout.trigger.height : undefined,
					bottom: actualSide === "top" && layout ? window.innerHeight - layout.trigger.top : undefined,

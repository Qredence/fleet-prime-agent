...
const LazySessionReasoningPanel = lazy(() =>
	import("@prime-agent/web-design/components/qredence-ui/chat/thinking/session-reasoning-panel").then(
		({ SessionReasoningPanel }) => ({
...
const LazyToolTimeline = lazy(() =>
	import("@prime-agent/web-design/components/qredence-ui/tools/tool-timeline").then(({ ToolTimeline }) => ({
...
const LazyPromptSuggestions = lazy(() =>
	import("@prime-agent/web-design/components/qredence-ui/chat/prompt-suggestions").then(({ PromptSuggestions }) => ({
...
const LazyMessageQueue = lazy(() =>
	import("@prime-agent/web-design/components/qredence-ui/tools/message-queue").then(({ MessageQueue }) => ({

				...
				{modes.map((mode) => {
					...
					return (
						<button
							...
							className={cn(
								"flex w-full cursor-pointer items-start gap-2 rounded-[6px] px-2 py-2 text-start text-label leading-4 text-foreground transition-[background-color,transform] duration-150 hover:bg-foreground/6 active:scale-[0.96]",

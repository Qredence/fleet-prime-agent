...
export function IconSpinner({ className, ...rest }: IconProps) {
	return (
		<svg
			...
			height="16"
			fill="none"
			className={className ?? "animate-spin text-muted-foreground will-change-transform"}
			{...rest}
		>
			<circle
				cx="12"
				...
				opacity={0.2}
			/>
			<path d="M12 2C6.48 2 2 6.48 2 12" stroke="currentColor" strokeWidth="3" strokeLinecap="round" fill="none" />
		</svg>
	);
}
